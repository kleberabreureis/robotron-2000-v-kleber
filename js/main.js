...
//método splice remove itens de uma array; splice ( , )
...
//função anônima pode ser substituída por função de seta, desta forma ()=>{o que a função executa}
...
//para acessar propriedades de objeto, usar array
    })
}